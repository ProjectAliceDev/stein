...
label chapter_one:
    ...
    sy "Looks like you're going to have to wait for Joe's OK."
    ...
    a 1v "Joe, we're just trying to tell the story as it is. No frills."
    ...
    sy 1bo "I guess Joe saw some potential flaw or whatever."
